...
export async function loginWithCredentials(email: string, password: string, companyCode?: string): Promise<void> {
  const res = await api.post('/auth/mobile/login', { email, password, companyCode });
