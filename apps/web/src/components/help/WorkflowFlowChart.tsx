...
> = {
  blue: {
    node: 'border-sky-200 bg-sky-50 text-sky-900 dark:border-sky-800 dark:bg-sky-950/50 dark:text-sky-100',
    connector: 'text-sky-400',
    ring: 'ring-sky-100 dark:ring-sky-900',
  },
  green: {
    node: 'border-emerald-200 bg-emerald-50 text-emerald-900 dark:border-emerald-800 dark:bg-emerald-950/50 dark:text-emerald-100',
    connector: 'text-emerald-400',
    ring: 'ring-emerald-100 dark:ring-emerald-900',
  },
  orange: {
    node: 'border-amber-200 bg-amber-50 text-amber-900 dark:border-amber-800 dark:bg-amber-950/50 dark:text-amber-100',
    connector: 'text-amber-400',
    ring: 'ring-amber-100 dark:ring-amber-900',
  },
  violet: {
    node: 'border-violet-200 bg-violet-50 text-violet-900 dark:border-violet-800 dark:bg-violet-950/50 dark:text-violet-100',
    connector: 'text-violet-400',
    ring: 'ring-violet-100 dark:ring-violet-900',
  },
  teal: {
    node: 'border-teal-200 bg-teal-50 text-teal-900 dark:border-teal-800 dark:bg-teal-950/50 dark:text-teal-100',
...
export function WorkflowFlowChart({ workflow }: WorkflowFlowChartProps) {
  ...
  return (
    <div className={cn('rounded-xl bg-slate-50/80 p-4 ring-1 dark:bg-slate-900/50', styles.ring)}>
      <p className="mb-4 text-center text-sm text-slate-500 dark:text-slate-400">{workflow.summary}</p>
