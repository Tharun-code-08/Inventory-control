    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-700 py-16 sm:py-20" aria-labelledby="final-cta-heading">
      ...
      {secondaryImage ? (
        <div className="pointer-events-none absolute bottom-4 left-[8%] hidden w-[22%] max-w-[180px] -rotate-6 lg:block">
          <MarketingImagePlaceholder slot={secondaryImage} className="shadow-xl shadow-indigo-950/25" aspectClassName="aspect-[9/16]" />
        </div>
      ) : null}
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal className="mx-auto max-w-xl text-center lg:max-w-lg lg:text-left">
          ...
          <p className="mt-4 text-lg text-indigo-100">{MARKETING_FINAL_CTA.body}</p>
