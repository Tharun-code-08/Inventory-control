...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-slate-200 bg-white p-6 text-slate-700 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
