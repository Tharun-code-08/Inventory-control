...
function buildInstructionsRows(options: ProductImportTemplateOptions): string[][] {
  const rows: string[][] = [
    ...
    [''],
    ['How to use'],
    ['1. Fill the "Products" sheet — one row per product. Do not change column headers.'],
    ['2. Product Code must be unique (letters, numbers, hyphen, underscore; max 40 chars).'],
    ['3. Category must match an existing category in Settings / product categories.'],
    ['4. Storage Location Code must match a code on the "Storage Locations" sheet for that plant.'],
    ['5. If a plant has only one storage location, you may leave Storage Location Code blank.'],
    ['6. Active Status: true / false (or yes / no / 1 / 0).'],
    ['7. Save as .xlsx and use Upload on the Products page.'],
    [''],
    ['Column guide'],
    ...
    ['Product Code', 'Required. Unique SKU code, e.g. PRD001'],
    ...
    ['Opening Stock', 'Required. Initial quantity at the plant'],
