...
export function supplierDeletionSubject(supplierName: string): string {
  return `Confirm supplier deletion: ${supplierName}`;
}

export function supplierDeletionText(content: SupplierDeletionEmailContent): string {
  return [
...
export function supplierDeletionHtml(content: SupplierDeletionEmailContent): string {
  return `<!DOCTYPE html>
<html>
