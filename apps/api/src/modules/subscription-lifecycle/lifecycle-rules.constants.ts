...
export const LIFECYCLE_CAMPAIGNS: LifecycleCampaignDefinition[] = [
  ...
  // Paid engagement
  {
    ...
    paidOnly: true,
    marketing: true,
    title: 'Getting started with Retail IMS',
    subtitle: 'Day 1 tips',
    paragraphs: [
      'Thanks for choosing Retail IMS. Here are quick wins to set up your workspace today.',
    ],
    bullets: [
  ...
  },
  {
    ...
    paidOnly: true,
    marketing: true,
    title: 'Sales and billing on Retail IMS',
  ...
  },
  {
    ...
    paidOnly: true,
    marketing: true,
    title: 'One month with Retail IMS',
  ...
  },
  {
    ...
    paidOnly: true,
    marketing: true,
    title: 'Your monthly Retail IMS update',
  ...
  ...([3, 1, 0] as const).flatMap((days) => [
    {
      ...
      paragraphs: ['Your Retail IMS subscription is coming up for renewal.'],
  ...
  ...([7, 3, 1, 0] as const).flatMap((days) => [
    {
      ...
      paragraphs: ['Your yearly Retail IMS plan is due for renewal soon.'],
      ctaPath: '/upgrade?renew=1',
  ...
  ...([1, 3, 7, 14, 21, 30, 45, 60, 75, 90] as const).map((day) => ({
    ...
    paragraphs: [`You are on day ${day} of your Retail IMS trial. Keep building momentum.`],
  ...
  })),
  {
    ...
    marketing: true,
    trialOnly: true,
    title: 'We miss you on Retail IMS',
  ...
  ...([7, 3, 1] as const).map((days) => ({
    ...
    paragraphs: ['Upgrade to Pro or Plus to keep your data and continue using Retail IMS.'],
    ctaPath: '/upgrade',
