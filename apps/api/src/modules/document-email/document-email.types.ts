...
export type DocumentEmailPayload =
  | PurchaseOrderEmailPayload
  | InvoiceEmailPayload
  | PaymentEmailPayload
  | SalesOrderEmailPayload
  | SupplierBillEmailPayload
  | SupplierPaymentEmailPayload
  | GoodsReceiptEmailPayload
  | SalesQuotationEmailPayload
  | GoodsReturnEmailPayload;
...
export function kindToEntityType(kind: DocumentPdfKind): string {
  return kind;
}
