...
exports.userInviteSubject = userInviteSubject;
exports.userInviteText = userInviteText;
exports.userInviteHtml = userInviteHtml;
function userInviteSubject(companyName) {
    return `You're invited to ${companyName} on SoftdigitIMS`;
}
function userInviteText(content) {
    return [
...
function userInviteHtml(content) {
    return `<!DOCTYPE html>
<html>
...
//# sourceMappingURL=user-invite.template.js.map