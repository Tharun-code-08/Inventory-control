...
exports.wrapBusinessEmailHtml = wrapBusinessEmailHtml;
const DEFAULT_SUPPORT_EMAIL = 'office@softdigitconsulting.com';
function wrapBusinessEmailHtml(content) {
    ...
    const maxWidthPx = Number.isFinite(content.maxWidthPx) ? Math.max(360, Math.floor(content.maxWidthPx)) : 520;
...
//# sourceMappingURL=email-layout.template.js.map