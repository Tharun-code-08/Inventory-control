...
exports.passwordResetOtpSubject = passwordResetOtpSubject;
exports.passwordResetOtpText = passwordResetOtpText;
exports.passwordResetOtpHtml = passwordResetOtpHtml;
function passwordResetOtpSubject() {
    return 'Reset your password - SoftdigitIMS';
}
function passwordResetOtpText(content) {
    return [
...
function passwordResetOtpHtml(content) {
    return `<!DOCTYPE html>
<html>
