...
exports.senderVerificationOtpSubject = senderVerificationOtpSubject;
exports.senderVerificationOtpText = senderVerificationOtpText;
exports.senderVerificationOtpHtml = senderVerificationOtpHtml;
function senderVerificationOtpSubject(companyName) {
    return `Verify your sender email for ${companyName}`;
}
function senderVerificationOtpText(content) {
    return [
...
function senderVerificationOtpHtml(content) {
    return `<!DOCTYPE html>
<html>
...
//# sourceMappingURL=sender-verification-otp.template.js.map