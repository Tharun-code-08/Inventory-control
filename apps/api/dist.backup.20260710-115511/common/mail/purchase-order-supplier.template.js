...
exports.purchaseOrderSubject = purchaseOrderSubject;
exports.purchaseOrderText = purchaseOrderText;
exports.purchaseOrderHtml = purchaseOrderHtml;
function purchaseOrderSubject(content) {
    return `Purchase Order ${content.poNumber} — ${content.companyName}`;
}
function purchaseOrderText(content) {
    const lines = [
    ...
    if (content.remarks)
        lines.push('', `Notes: ${content.remarks}`);
    lines.push('', 'Thank you,', content.companyName);
    return lines.join('\n');
}
function purchaseOrderHtml(content) {
...
//# sourceMappingURL=purchase-order-supplier.template.js.map