...
exports.returnNoticeSubject = returnNoticeSubject;
exports.returnNoticeText = returnNoticeText;
exports.returnNoticeHtml = returnNoticeHtml;
function returnNoticeSubject(content) {
    return `Return Notice - ${content.returnNumber} | ${content.companyName}`;
}
function returnNoticeText(content) {
    const lines = [
        ...
        '',
        'Returned items:',
        ...content.lines.map((line) => `- ${line.code} ${line.description ? `(${line.description}) ` : ''}| GRN Qty: ${line.grnQuantity} | Return Qty: ${line.returnQuantity} | Reason: ${line.reason} | Images: ${line.imageCount}`),
        '',
...
function returnNoticeHtml(content) {
...
//# sourceMappingURL=return-notice.template.js.map