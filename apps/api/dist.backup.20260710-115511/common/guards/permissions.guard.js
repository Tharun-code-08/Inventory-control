...
const require_any_permission_decorator_1 = require("../decorators/require-any-permission.decorator");
...
let PermissionsGuard = class PermissionsGuard {
    ...
    canActivate(context) {
        ...
        const requiredAny = this.reflector.getAllAndOverride(require_any_permission_decorator_1.PERMISSIONS_ANY_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
        ...
        if ((user.role === client_1.RoleName.SHOP_USER ||
            user.role === client_1.RoleName.WAREHOUSE_STAFF ||
            user.role === client_1.RoleName.EMPLOYEE ||
            user.role === client_1.RoleName.SALES ||
            user.role === client_1.RoleName.VIEWER ||
            user.role === client_1.RoleName.VENDOR) &&
            shopIdParam &&
            user.shopId &&
