...
exports.buildPurchaseOrderHtml = buildPurchaseOrderHtml;
const Handlebars = require("handlebars");
const document_pdf_types_1 = require("../document-pdf.types");
const BLUE = document_pdf_types_1.DOCUMENT_PDF_BRAND.primary;
const BLUE_LIGHT = document_pdf_types_1.DOCUMENT_PDF_BRAND.primaryLight;
...
<body>
  ...
  <p class="generated">Generated by SoftdigitIMS</p>
</body>
</html>`);
function buildPurchaseOrderHtml(data) {
    return PURCHASE_ORDER_TEMPLATE({
        ...data,
        padRows: Array.from({ length: data.padRowCount }, () => ({})),
    });
}
//# sourceMappingURL=purchase-order.template.js.map