...
exports.DUNNING_CAMPAIGN_KEYS = exports.DUNNING_OFFSETS_DAYS = exports.RENEWAL_OFFSETS = exports.LIFECYCLE_CAMPAIGN_MAP = exports.LIFECYCLE_CAMPAIGNS = exports.TRIAL_FEATURE_CHECKLIST = exports.PLATFORM_TEMPLATE_PREFIX = exports.SUBSCRIPTION_LIFECYCLE_QUEUE = void 0;
exports.SUBSCRIPTION_LIFECYCLE_QUEUE = 'subscription-lifecycle';
exports.PLATFORM_TEMPLATE_PREFIX = 'platform_';
exports.TRIAL_FEATURE_CHECKLIST = [
    'login',
    'product_created',
    'gr_posted',
    'gi_posted',
...
exports.LIFECYCLE_CAMPAIGNS = [
    ...
    ...[1, 3, 7, 14, 21, 30, 45, 60, 75, 90].map((day) => ({
        key: `trial_day_${day}`,
        kind: 'trial_nurture',
        dayOffset: day,
        trialOnly: true,
...
exports.LIFECYCLE_CAMPAIGN_MAP = new Map(exports.LIFECYCLE_CAMPAIGNS.map((c) => [c.key, c]));
exports.RENEWAL_OFFSETS = {
    MONTHLY: [3, 1, 0],
    YEARLY: [7, 3, 1, 0],
};
exports.DUNNING_OFFSETS_DAYS = [0, 1, 3, 7, 14];
exports.DUNNING_CAMPAIGN_KEYS = [
    'dunning_immediate',
    'dunning_1d',
    'dunning_3d',
    'dunning_7d',
...
//# sourceMappingURL=lifecycle-rules.constants.js.map